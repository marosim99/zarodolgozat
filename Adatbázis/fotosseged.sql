...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2019. Ápr 01. 03:55
...
(16, 'Sikerült is, két képet is feltöltöttem :D köszi a segítséget', '2019-03-24 22:09:58', 45),
(19, 'Nagyon szívesen! :D Majd vetek rájuk egy pillantást', '2019-03-24 22:10:19', 27);
...
(10, 'P1030157.jpg', 'Formációs repülés', 'Kedvenc képem a kedvenc gépemmel (mármint fényképezőgéppel) :)))', 'Szeged', '2019-03-24', '2018-09-22'),
...
(1, 'marosim99', '$2y$10$vYzV8PAE0i6DUmi8y4RlxeUGZhuFTK6VRdSj9CSzyXnlGN2fq0yn2', 'férfi', 'marosim99@gmail.com', 'Imádok fotózni :D', '2019-03-17', 1),
(27, 'admin', '$2y$10$cCUQyjwfiy4GSYtz4JSId.H64aaXbGFidfWtSMwlGisPE6M3WGA7y', 'férfi', 'admin@admin.com', 'Admin vagyok!', '2019-02-27', 1),
...
--
ALTER TABLE `chat`
  MODIFY `uzenet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
